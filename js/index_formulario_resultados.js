...
document.addEventListener("DOMContentLoaded", function () {
    ...
    formulario.addEventListener("submit", function (event) {
        ...
        let año_maximo = document.getElementById("año_maximo").value !== "hasta" ? document.getElementById("año_maximo").value : new Date().getFullYear();
        ...
        let consulta = `nombre_juego=${encodeURIComponent(nombre_juego)}&generos=${genero}&plataformas=${plataforma}&duracion_minima=${duracion_minima}&duracion_maxima=${duracion_maxima}&año_minimo=${año_minimo}&año_maximo=${año_maximo}&multi=${multi}&goty=${goty}&obra_maestra=${obra_maestra}&estrellas=${valoracion_minima}`;
            ...
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (juegos.length === 0) {
                    ...
                    juegos.forEach(juego => {
                        ...
                        let obra_maestra = juego.obra_maestra == "1" ? '<img class="etiqueta_obra_maestra" src="../multimedia/logos/obra_maestra.jpg" alt="Obra Maestra">' : "";
