document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (event) {
        ...
        if (pantalla_registro) {
            if (validar_campos()) {  // Si las validaciones son correctas
    ...
    function enviar_datos() {
        ...
        let datos = `email=${encodeURIComponent(email.value)}&usuario=${encodeURIComponent(usuario.value)}&contraseña=${encodeURIComponent(contraseña.value)}`;
